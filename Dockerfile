...
RUN wget -q https://downloads.apache.org/kafka/3.0.1/kafka_2.13-3.0.1.tgz && tar zxvf kafka_2.13-3.0.1.tgz && rm kafka_2.13-3.0.1.tgz

ENV KAFKA_HOME /home/kafka/kafka_2.13-3.0.1
...
WORKDIR /home/kafka/kafka_2.13-3.0.1
